...
@testset "test_InletTempConstraint_M_parallel_no_flow" begin
    Nbr = 3
    Nb = 3
    Nt = 1
...
@testset "test_InletTempConstraint_M_parallel_no_flow_partial" begin
    Nbr = 3
    Nb = 3
    Nt = 1
...
@testset "test_InletTempConstraint_M_series_no_flow" begin
    Nbr = 1
    Nb = 3
    Nt = 1
...
@testset "test_InletTempConstraint_M_mixed_no_flow" begin
    Nbr = 3
    Nb = 5
    Nt = 1
...
@testset "test_InletTempConstraint_b_no_flow" begin
    Nbr = 3
    Nb = 3
    Nt = 10
