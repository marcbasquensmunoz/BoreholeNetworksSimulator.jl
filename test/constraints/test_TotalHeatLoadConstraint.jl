...
@testset "test_TotalHeatLoadConstraint_M_parallel" begin
    ...
    expected = [
        (1, 1, -1.), (1, 3, 1.),
        (2, 1, -1.), (2, 5, 1.),
        (3, 3Nb+1, H), (3, 3Nb+2, H), (3, 3Nb+3, H)
    ]
    @test test_sparse_matrix(M, expected)
end


@testset "test_TotalHeatLoadConstraint_M_parallel_no_flow" begin
    Nbr = 3
    Nb = 3
    Nt = 1
...
@testset "test_TotalHeatLoadConstraint_M_parallel_no_flow_partial" begin
    Nbr = 3
    Nb = 3
    Nt = 1
...
@testset "test_TotalHeatLoadConstraint_M_series_no_flow" begin
    Nbr = 1
    Nb = 3
    Nt = 1
...
@testset "test_TotalHeatLoadConstraint_M_mixed" begin
    ...
    expected = [
        (1, 1, -1.), (1, 5, 1.),
        (2, 1, -1.), (2, 9, 1.),
        (3, 3Nb+1, H), (3, 3Nb+2, H), (3, 3Nb+3, H), (3, 3Nb+4, H), (3, 3Nb+5, H)
    ]
    @test test_sparse_matrix(M, expected)
end

@testset "test_TotalHeatLoadConstraint_M_mixed_no_flow" begin
    Nbr = 3
    Nb = 5
    Nt = 1
...
@testset "test_TotalHeatLoadConstraint_b" begin
    ...
    @test b_time[end, :] == Q_tot
end

@testset "test_TotalHeatLoadConstraint_b_no_flow" begin
    Nbr = 3
    Nb = 3
    Nt = 10
